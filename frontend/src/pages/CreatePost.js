  ...
  return (
    <section className='bg-slate-50 mx-auto py-20 w-full'>
      <div className='flex flex-col items-center gap-8 w-full'>
         ...
         <form className='flex flex-col gap-8 w-1/2 lg:w-1/3' action={handleCreatePost}>
          ...
          <button type='submit' className='bg-gray-800 text-white rounded-lg py-3 px-2'>Add Post</button>
         </form>
      </div>
    </section>
  )
